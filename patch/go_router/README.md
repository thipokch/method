...
Follow the [package install instructions](https://pub.dev/package/go_router/install),
...
example, see the 
[ShellRoute sample](https://github.com/flutter/package/tree/main/package/go_router/example/lib/shell_route.dart)
in the example/ directory.

### Still not sure how to proceed?
See [examples](https://github.com/flutter/package/tree/main/package/go_router/example) for complete runnable examples or visit [API documentation](https://pub.dev/documentation/go_router/latest/go_router/go_router-library.html)
...
See the [Changelog](https://github.com/flutter/package/blob/main/package/go_router/CHANGELOG.md)
