...
///
/// See [Sub-routes](https://github.com/flutter/package/blob/main/package/go_router/example/lib/sub_routes.dart)
...
class GoRoute extends RouteBase {
  ...
  /// ```
  ///
  /// See the [named routes example](https://github.com/flutter/package/blob/main/package/go_router/example/lib/named_routes.dart)
  ...
  /// in [GoRouterState].
  ///
  /// See [Query parameters and path parameters](https://github.com/flutter/package/blob/main/package/go_router/example/lib/sub_routes.dart)
  ...
  /// authentication. See [Redirection](https://github.com/flutter/package/blob/main/package/go_router/example/lib/redirection.dart)
  /// for a complete runnable example.
  ///
