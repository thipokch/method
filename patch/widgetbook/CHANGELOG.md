...
- feat: added [device_frame](https://pub.dev/package/device_frame) ([#112](https://github.com/widgetbook/widgetbook/pull/114))
...
- added dependency to [package:widgetbook_models](https://pub.dev/package/widgetbook_models) which defines the `Device` class.
...
- replacing [font_awesome_flutter](https://pub.dev/package/font_awesome_flutter) package with Material icons
- removing [google_fonts](https://pub.dev/package/google_fonts) package
- removing [recase](https://pub.dev/package/recase) package
