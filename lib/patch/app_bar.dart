...
/// app bar, see [SliverAppBarPatch], which embeds an [AppBarPatch] in a sliver for use in
/// a [CustomScrollView].
///
...
/// English):
///
/// The [AppBarPatch] insets its content based on the ambient [MediaQuery]'s padding,
/// to avoid system UI intrusions. It's taken care of by [Scaffold] when used in
/// the [Scaffold.appBar] property. When animating an [AppBarPatch], unexpected
/// [MediaQuery] changes (as is common in [Hero] animations) may cause the content
/// to suddenly jump. Wrap the [AppBarPatch] in a [MediaQuery] widget, and adjust its
...
///
/// If the [leading] widget is omitted, but the [AppBarPatch] is in a [Scaffold] with
...
///
/// {@tool dartpad}
/// This sample shows an [AppBarPatch] with two simple actions. The first action
...
/// {@tool dartpad}
/// This sample shows the creation of an [AppBarPatch] widget with the [shadowColor] and
...
///
/// {@tool dartpad}
/// This sample shows an [AppBarPatch] with two action buttons with their primary
...
/// See also:
///
///  * [Scaffold], which displays the [AppBarPatch] in its [Scaffold.appBar] slot.
///  * [SliverAppBarPatch], which uses [AppBarPatch] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [AppBarPatch]
...
class AppBarPatch extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Used by [Scaffold] to compute its [AppBarPatch]'s overall height. The returned value is
  /// the same `preferredSize.height` unless [AppBarPatch.toolbarHeight] was null and
  ...
  /// the app bar's [AppBarPatch.bottom] widget.
  ...
  /// [AppBarPatch] will imply an appropriate widget. For example, if the [AppBarPatch] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [AppBarPatch]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [AppBarPatch] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [AppBarPatch]'s container
  /// changes the [AppBarPatch]'s size. A [SliverAppBarPatch] in a [CustomScrollView]
  /// changes the [AppBarPatch]'s height when scrolled.
  ///
  ...
  /// null, then [AppBarPatch] uses the overall theme's [ColorScheme.primary] if the
  ...
  /// value is also null, then [AppBarPatch] uses the overall theme's
  ...
  /// used by [SliverAppBarPatch] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  /// {@endtemplate}
  ...
  /// Defines the height of the toolbar component of an [AppBarPatch].
  ///
...
/// the screen see [AppBarPatch], which is used in the [Scaffold.appBar] slot.
///
...
///
/// {@tool dartpad}
/// This sample shows a [SliverAppBarPatch] and it's behavior when using the
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverAppBarPatch] into its
///    scrolling.
///  * [AppBarPatch], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [AppBarPatch]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
class SliverAppBarPatch extends StatefulWidget {
  ...
  ///
  /// Returns a [SliverAppBarPatch] configured with appropriate defaults
  ...
  /// See also:
  ///
  ///   * [AppBarPatch], for a small or center-aligned top app bar.
  ...
  ///
  /// This property is used to configure an [AppBarPatch].
  final Widget? leading;
  ...
  /// content is not scrolled under the [AppBarPatch].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [AppBarPatch] is being displayed over content that is scrolled under it.
  ///
  ...
  /// See also:
  ///
  ///  * [SliverAppBarPatch] for more animated examples of how this property changes the
