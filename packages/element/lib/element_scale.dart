...
class ElementScale {
  ...
  static const typescaleHeadlineLarge = 32 + .0;
  static const typescaleHeadlineMedium = 28 + .0;
  static const typescaleHeadlineSmall = 24 + .0;
  static const typescaleTitleLarge = 22 + .0;
  static const typescaleTitleMedium = 16 + .0;
  static const typescaleTitleSmall = 14 + .0;
  static const typescaleBodyLarge = 16 + .0;
  static const typescaleBodyMedium = 14 + .0;
  static const typescaleBodySmall = 12 + .0;
  static const typescaleLabelLarge = 14 + .0;
  ...
  static const emojiM = TextStyle(fontSize: iconM, height: 1);
  static const emojiL = TextStyle(fontSize: iconL, height: 1);
  static const emojiXL = TextStyle(fontSize: iconXL, height: 1);
}
