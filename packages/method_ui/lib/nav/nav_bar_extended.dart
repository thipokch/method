...
class MethodExtendedSliverNavigationBar extends StatefulWidget {
  const MethodExtendedSliverNavigationBar({
    Key? key,
    this.largeTitle,
    this.leading,
  ...
  @override
  State<MethodExtendedSliverNavigationBar> createState() =>
      _MethodExtendedSliverNavigationBarState();
}

class _MethodExtendedSliverNavigationBarState
    extends State<MethodExtendedSliverNavigationBar> {
