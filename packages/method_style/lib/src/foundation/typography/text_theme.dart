...
typedef _ = MtTextStyle;

abstract class MtTextTheme {
...
extension _ScaleFactor on TextStyle {
  TextStyle get _small =>
      copyWith(fontSize: fontSize! * MtTextTheme._smallTextScaleFactor);

  TextStyle get _large =>
      copyWith(fontSize: fontSize! * MtTextTheme._largeTextScaleFactor);
}
