...
import 'package:method_style/method_style.dart' show MtEasing, MtDurations;
...
/// {@tool snippet}
///
/// For typical use, pass the [InkSparklePatch.splashFactory] to the `splashFactory`
...
class InkSparklePatch extends InteractiveInkFeature {
  ...
  InkSparklePatch({
    ...
    _radiusScale = TweenSequence<double>(
      <TweenSequenceItem<double>>[
        TweenSequenceItem<double>(
          tween: CurveTween(curve: MtEasing.fastOutSlowIn),
          weight: 75,
        ),
        TweenSequenceItem<double>(
  ...
  static const Duration _animationDuration = MtDurations.dalayed;
