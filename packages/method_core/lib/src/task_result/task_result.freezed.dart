...
mixin _$TaskResult {
  ...
  List<TaskResultDetail> get results => throw _privateConstructorUsedError;
...
class _$_TaskResult extends _TaskResult {
  ...
  final List<TaskResultDetail> _results;
  @override
  List<TaskResultDetail> get results {
...
abstract class _TaskResult extends TaskResult {
  const factory _TaskResult(
      ...
      required final List<TaskResultDetail> results}) = _$_TaskResult;
