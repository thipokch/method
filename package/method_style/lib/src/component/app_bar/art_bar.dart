      ...
      leading: widget.leading ??
          (ModalRoute.of(context)?.canPop ?? false
              ? IconButton(
                  ...
                  icon: const Icon(MtSymbols.chevronCircleBackFilled),
                  iconSize: 32.00,
        ...
        title: Builder(
          builder: (context) {
            ...
            return Column(
              ...
              children: [
                Opacity(
                  opacity: 1.0 - MtEasing.easeOutExpo.transform(t),
                  child: Padding(
                    padding: const EdgeInsets.all(MtSpaces.S),
                    child: Padding(
                ...
                Opacity(
                  opacity: 1 - MtEasing.easeOutExpo.transform(t),
                  child: ClipRect(
                    child: Align(
                        ...
                        child: Column(
                          children: [
                            ...
                            if (widget.action != null)
                              Padding(
                                padding: const EdgeInsets.all(MtSpaces.L),
                                child: SizedBox(
